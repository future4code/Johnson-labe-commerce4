...
function Footer() {
  const construir = () => {
    alert("...implementação em desenvolvimento!");
  };
    ...
    <div className="footer">
      ...
      <div className="footer__container">
        <div className="footer__stuff">
          <div onClick={construir} className="footer__one">
          ...
          <div onClick={construir} className="footer__two">
            <div className="footer__title">
          ...
          <div onClick={construir} className="footer__three">
            <div className="footer__title">
          ...
          <div onClick={construir} className="footer__four">
            <div className="footer__title">
